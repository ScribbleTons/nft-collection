...
import abi from "../artifacts/contracts/CryptoDevs.sol/CryptoDevs.json";
...
export default function Home() {
   ...
   * signing capabi.abilities of metamask attached
   *
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        ...
        <div>
          <img className={styles.image} src="./crypto-dev/0.svg" />
        </div>
      </div>
